...
# --- Data ---
# Data from Table 3 of the research analysis, in tonnes of CO2 equivalent (tCO2e).
# The years and host cities correspond to the ICML conference data.
years = ['2019\nLong Beach', '2022\nBaltimore', '2023\nHawaii', '2024\nVienna', '2025\nVancouver']
emissions_data = {
    'Venue': np.array([12.1, 18.2, 22.6, 31.0, 38.5]),
    'Meals': np.array([23.6, 35.3, 44.0, 60.3, 75.0]),
    'Accommodation': np.array([68.6, 83.4, 196.8, 148.7, 82.4]),
    'Air Travel': np.array([695.9, 1118.5, 1914.5, 2413.4, 2739.9])
}
...
# --- Plotting ---
fig, ax = plt.subplots(figsize=(8,5)) # Figure size for grouped bars
...
# --- Titles and Labels ---
ax.set_title('ICML Conference Carbon Emissions by Accepted Papers (2019-2025)', fontsize=16, fontweight='bold', pad=20)
...
plt.savefig('ICML_Emissions_Graph.png', dpi=300, bbox_inches='tight')
plt.show()
print("save image in /shared/hdd/nuochen/AI-Scientist-research-plan-eval/ICML_Emissions_Graph.png")